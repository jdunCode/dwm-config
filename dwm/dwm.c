...
static void focusstack_wrapper(const Arg *arg) {
	focusstack(arg->i, 0);
}
static void focusstack(int inc, int hid);
...
static int gappoh = 10;           // Горизонтальный внешний gap
static int gappov = 10;           // Вертикальный внешний gap
static int gappih = 10;           // Горизонтальный внутренний gap
static int gappiv = 10;           // Вертикальный внутренний gap
